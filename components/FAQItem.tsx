  ...
  return (
    ...
    >
      <div className="flex justify-between items-center gap-4">
        <h3 className="font-heading text-2xl md:text-3xl group-hover:text-brand-red transition-colors">{q}</h3>
        <span className={`faq-icon transition-transform duration-500 transform ${isOpen ? 'rotate-90' : ''}`}>
      ...
      <div 
        ...
        style={{ maxHeight: isOpen ? '300px' : '0', opacity: isOpen ? '1' : '0', marginTop: isOpen ? '1.25rem' : '0' }}
      >
